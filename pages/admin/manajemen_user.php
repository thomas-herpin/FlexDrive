                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                                            ...
                                            <td class="py-3 px-4 text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <a href="edit_user.php?id=<?= $row['id'] ?>" class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                                    <a href="hapus_user.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus pengguna ini?')" class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php endwhile;
